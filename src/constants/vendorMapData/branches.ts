  ...
  thonglor: {
    ...
    floors: [
      ...
      },
      {
        ...
        vendors: Array.from({ length: 13 }, (_, index) => ({ lotNumber: index + 1 })),
      },
      {
        id: '2',
        label: '2',
    ...
    floors: [
      {
        id: '1',
        label: '1',
        mapSrc: '/map/c11/1-gs/CL11-GS-outline.svg',
      ...
      },
      {
        id: '2',
        label: '2',
        mapSrc: '/map/c11/2-mk/CL11-MK-outline.svg',
      ...
      },
      {
        id: '3',
        label: '3',
        mapSrc: '/map/c11/3-py/CL11-PY-outline.svg',
      ...
      },
      {
        id: '4',
        label: '4',
        mapSrc: '/map/c11/4-gw/CL11-GW-outline.svg',
