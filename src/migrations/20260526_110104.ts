...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_vendors\`("id", "media_id", "name", "slug", "branch_id", "floor", "floor_location", "lot_number", "category_id", "description", "opening_hours", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at") SELECT "id", "media_id", "name", "slug", "branch_id", "floor", "floor_location", "lot_number", "category_id", "description", "opening_hours", "meta_title", "meta_description", "meta_image_id", "updated_at", "created_at" FROM \`vendors\`;`,
  )
