/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ca047a35646cb91625a1136d9a184da3)
...
interface __BaseEnv_CloudflareEnv {
	...
	CONTACT_INQUIRY_TO_EMAIL: string;
	WORKER_SELF_REFERENCE: Fetcher /* the-common */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "CONTACT_INQUIRY_TO_EMAIL">> {}
}
